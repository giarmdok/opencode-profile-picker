...
Resolve API keys for a selected profile, build a launch environment, and spawn OpenCode as a child process with the appropriate environment variables and platform-specific behavior.
