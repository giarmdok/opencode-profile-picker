...
Apply a selected OMO preset by writing it to the global OMO configuration file, with graceful handling of edge cases and detection of project-local overrides.
