...
Encrypted storage and management of API key sets with a master password. Supports create, read, update, and delete operations on key sets and individual keys, with Fernet encryption derived from a PBKDF2-SHA256 key.
